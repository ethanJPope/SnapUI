...
public class SnapUIInspectorWindow : EditorWindow
{
    ...
    private SerializedObject soButton;
    ...
    private bool foldInteractions = true;
    ...
    private void RefreshSelection()
    {
        ...
        uiButton = selectedGO.GetComponent<Button>();
        ...
        soButton = uiButton != null ? new SerializedObject(uiButton) : null;
    }
    ...
    {
        foldInteractions = EditorGUILayout.BeginFoldoutHeaderGroup(foldInteractions, "Interactions");
        if (!foldInteractions)
        {
        ...
        if (soButton == null)
        {
            EditorGUILayout.HelpBox("No Button component found.", MessageType.Info);
            EditorGUILayout.EndFoldoutHeaderGroup();
            return;
        }
        ...
        EditorGUILayout.PropertyField(soButton.FindProperty("m_Interactable"), new GUIContent("Interactable"));
        EditorGUILayout.PropertyField(soButton.FindProperty("m_OnClick"), new GUIContent("On Click"));

        ApplyThrottled(soButton);
        EditorGUI.indentLevel--;
        EditorGUILayout.EndFoldoutHeaderGroup();
    }
